...
public final class FragmentSecondBinding implements ViewBinding {
  ...
  private FragmentSecondBinding(@NonNull ConstraintLayout rootView, @NonNull Button buttonPref,
      @NonNull Button buttonSecond, @NonNull TextView textviewSecond) {
    this.rootView = rootView;
    this.buttonPref = buttonPref;
  ...
  public static FragmentSecondBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.button_pref;
      Button buttonPref = ViewBindings.findChildViewById(rootView, id);
      if (buttonPref == null) {
        break missingId;
      }
      ...
      return new FragmentSecondBinding((ConstraintLayout) rootView, buttonPref, buttonSecond,
          textviewSecond);
    }
